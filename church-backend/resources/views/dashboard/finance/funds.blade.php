                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-12">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#daily"
                                                role="tab" aria-controls="profile" aria-selected="false">Daily</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content border-1" id="myTabContent">
                                        <div class="tab-pane fade show active" id="general" role="tabpanel"
                                            aria-labelledby="home-tab">
                                            <form class="row search-funds-form pt-3" method='GET'
                                                action="{{ url('funds/search') }}">
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control form-control-alternative"
                                                        name="msearch" placeholder="search name, email" />
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <button class='btn btn-primary' style='width: 100%;'
                                                        disabled="disabled"><i class='fas fa-search'></i> Search</button>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="tab-pane fade" id="daily" role="tabpanel"
                                            aria-labelledby="profile-tab">
                                            <form class="row daily-search-funds-form pt-3" method='GET'
                                                action="{{ url('funds/search') }}">
                                                <div class="col">
                                                ...
                                                <div class="col">
                                                    <input type="text" class="form-control mydatepicker"
                                                        name="date" placeholder="From" readonly />
                                                </div>
                                                <div class="col">
