...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-header"><i class='fas fa-microphone'></i> New Sermon</h5>
                </div><!-- /.col -->
            ...
            <div class="row">
                <div class="col-xl-12 mb-5 mb-xl-0">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ url('dashboard/spiritual/sermons/add') }}"
                                enctype="multipart/form-data" class="row d-flex align-items-center sermon-form">
                                @csrf
                                ...
                                <div class='form-group col-sm-12'>
                                    ...
                                    <input name="title" type="text" placeholder="Sermon Title" class="form-control"
                                        style="max-width: 500px">
                                </div>
                                <div class='form-group col-sm-12'>
                                    <label style="font-weight: 200; font-size: 0.9em;">Banner Image</label><br>
                                    <div class="d-none banner" style="max-width: 500px;">
                                        <img src="{{ asset('website/homepage/default.jpg') }}" class="img-fluid"
                                            id="view-banner">
                                    </div>
                                    <span class="btn btn-white btn-add-banner">Choose</span> <span class='text-primary'>No
                                        file choosen</span>
                                    <p class='small alert mt-4' style="background-color: #dee; max-width: 500px;">This is
                                        the image that appears when sharing the message on the website</p>
                                </div>
                                <div class='form-group col-sm-12'>
                                    ...
                                    <table style="max-width: 500px;">
                                        <tr>
                                            ...
                                            <td><input name="hours" class="form-control" value="1"
                                                    style="max-width: 80px;"></td>
                                            <td class='pl-2 pr-2'>Minutes:</td>
                                            <td><input name="minutes" class="form-control" style="max-width: 80px;"></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class='form-group col-sm-12'>
                                    <label><small>Sermon Day and Time</small></label>
                                    <input name="date" type="text" placeholder="Sermon Date"
                                        class="form-control mydatepicker" required readonly style="max-width: 500px;">
                                    <p class='small alert mt-4' style="background-color: #dee; max-width: 500px;">Future
                                        sermons will be treated as upcoming services</p>
                                </div>
                                <div class='form-group col-sm-12'>
                                    <label style="font-weight: 200; font-size: 0.9em;">Youtube Link</label>
                                    <input name="youtube" type="text" placeholder="Youtube Link" class="form-control"
                                        value="#" style="max-width: 500px;">
                                </div>
                                <div class='form-group col-sm-12'>
                                    <label style="font-weight: 200; font-size: 0.9em;">Audio (Sound Cloud Embed)</label>
                                    <input name="audio_link" type="text" placeholder="Audio Link" class="form-control"
                                        value="#" style="max-width: 500px;">
                                </div>
                                <div class="col-sm-12">
                                    <!--Youtube::getVideoInfo(Youtube::parseVidFromURL('https://www.youtube.com/watch?v=moSFlvxnbgk'))->player->embedHtml-->
                                </div>
                                <div class="col-sm-12">
                                    <div style="max-width: 500px;">
                                        <label style="font-weight: 200; font-size: 0.9em;">Notes</label>
                                        <textarea name="description" placeholder="Sermon Content" rows="5" class="form-control summernote"></textarea>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-3 pb-0 mb-0">
                    <div class="col-sm-12 d-none video">
                        <video controls>
                            <source src="{{ asset('sermon/default.mp4') }}" type="video/mp4" id="view-video">
                        </video>
