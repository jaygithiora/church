...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-header"><i class='fas fa-comment'></i> SMS(s)</h5>
                </div><!-- /.col -->
                <div class="col-sm-6 text-right">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('dashboard/home') }}">Home</a></li>
                        <li class="breadcrumb-item active">SMS(s)</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <!--
                                <div class="col">
                                    <h3 class="mb-0"><i class="fas fa-comments"></i> | SMS(s)</h3>
                                </div>-->
                                <div class="col text-right">
                                    <button class='btn btn-danger delete-sms btn-sm shadow'><span
                                            class="d-block d-lg-none"><i class="fas fa-trash"></i></span><span
                                            class="d-none d-lg-block">Delete</span></button>
                                    <button class='btn btn-primary btn-sm newsms'><span class="d-block d-lg-none"><i
                                                class="fas fa-comments"></i></span><span class="d-none d-lg-block">New
                                            SMS</span></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <div class='row'>
                                    @if ($sms->isEmpty())
                                        <div class='col-sm-12'>
                                            <div class="alert alert-warning alert-dismissible fade show -5" role="alert">
                                                <strong><i class='fas fa-ban'></i> </strong> No SMS yet.
                                    ...
                                    @foreach ($sms as $message)
                                        <div class='col-sm-12'>
                                            <a href='{{ url('dashboard/communication/sms/view/' . $message->id) }}' style="color: rgba(0,0,0,.8);">
                                                <div class='row border-bottom align-items-center mb-1 pb-1'>
                                                    <div class='col mycheck' style='max-width: 20px;'>
                                                        <input name='messages[]' id='{{ $message->id }}'
                                                    ...
                                                    <div class='col' style='max-width:200px'>
                                                        <strong class='text-muted'>{{ $message->recipients }}
                                                            Member(s)</strong>
                                                    </div>
                                                    ...
                                                    <div class='col text-right' style="max-width: 100px;">
                                                        <span
                                                            class='font-weight-bold small'>{{ \Carbon\Carbon::parse($message->sent)->diffForHumans() }}</span>
                                                    </div>
            ...
            <div class="col-sm-12 p-4">
                <form action="{{ url('dashboard/communication/sms/send') }}" method="POST">
                    ...
                    <div class='form-group' style="p-2">
                        <div class='input-group'>
                            <textarea class='form-control' maxlength="160" name="message" rows="2"
                                style="border: 2px solid #ddd; border-radius: 0px;" placeholder="Enter message here. 160 characters ONLY"></textarea>
