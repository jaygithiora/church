        ...
        <div class="col-xl-12 mb-5 mb-xl-0">
            <div class="card mt-3 tab-card shadow">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active p-3 bg-secondary" id="basic" role="tabpanel" aria-labelledby="one-tab">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="level">
                                            @foreach($roles as $role)
                                                <option value="{{$role->role}}" {{$user == null?'':$user->role==$role->role?'selected':''}}>{{$role->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
