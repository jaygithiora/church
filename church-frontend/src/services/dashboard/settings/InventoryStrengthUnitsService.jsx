...
const getInventoryStrengthUnits = async (page = 1, enqueueSnackbar) => {
    try {
        //const response = await API.get(`/dashboard/settings/specialities?page=${page}`);
        const response = await API.get(`/dashboard/settings/inventory_strength_units?page=${page}`);
        return response.data.inventory_strength_units
...
const addInventoryStrengthUnit = async (formData, enqueueSnackbar) => {
    try {
        const response = await API.post("/dashboard/settings/inventory_strength_units/add", formData, {
            headers: {
...
const InventoryStrengthUnitsService = {
    getInventoryStrengthUnits, addInventoryStrengthUnit
}

export default InventoryStrengthUnitsService