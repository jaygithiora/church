...
const getInventoryCategories = async (page = 1, enqueueSnackbar) => {
    try {
        //const response = await API.get(`/dashboard/settings/specialities?page=${page}`);
        const response = await API.get(`/dashboard/settings/inventory_categories?page=${page}`);
        return response.data.inventory_categories
...
const addInventoryCategory = async (formData, enqueueSnackbar) => {
    try {
        const response = await API.post("/dashboard/settings/inventory_categories/add", formData, {
            headers: {
...
const InventoryCategoriesService = {
    getInventoryCategories, addInventoryCategory
}
